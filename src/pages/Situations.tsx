    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gerencie os status das ordens de serviço</p>
        </div>
        <Button>
      ...
      <div className="flex items-center justify-center h-[400px] rounded-lg border-2 border-dashed bg-muted/10">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Gestão de situações e cores personalizadas será implementada em breve
          </p>
        </div>
      </div>
    </div>
